...
const common = {
  ...
  EMAIL_TOKEN_SECRET: "ci-placeholder-email-token-secret-000000000000001",
...
const app = {
  ...
  AUTH_SECRET: "ci-placeholder-auth-secret-0000000000000001",
  BOOKING_CAPABILITY_KEY_ID: "ci-free-only-v1",
  BOOKING_CAPABILITY_SECRET: "ci-placeholder-booking-capability-secret-00000001",
  TENANT_CONTEXT_SECRET: "ci-placeholder-tenant-context-secret-000000000001",
  RATE_LIMIT_HASH_SECRET: "ci-placeholder-rate-limit-hash-secret-000000000001",
  PROXY_SHARED_SECRET: "ci-placeholder-proxy-shared-secret-000000000001",
  OPERATOR_HEALTH_SECRET: "ci-placeholder-operator-health-secret-000000000001",
};
const worker = {
  ...common,
